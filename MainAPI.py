...
async def v1_parse_pim_fields(
    ...
    if inputOpenAIAPIKey == os.getenv('CUSTOM_SECRET1'): 
        inputOpenAIAPIKey = os.getenv('AZURE_OPENAI_KEY')
        try:
            # TIME START
        ...
        raise HTTPException(status_code=999, detail='Critical Error: Incorrect API Key')