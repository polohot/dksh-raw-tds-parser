...
async def v1_parse_pim_fields(
    ...
    inputAzureOpenAIURL: Annotated[str, Form(...)],
    inputAzureOpenAIAPIKey: Annotated[str, Form(...)],
    ...
    try:
        ...
        mainDict = {
            ...
            'inputAzureOpenAIURL':inputAzureOpenAIURL,
            'inputAzureOpenAIAPIKey': inputAzureOpenAIAPIKey,
        ...
        mainDict['gpt_composition_search_answer'] = ''
        mainDict['gpt_function_search_answer'] = ''
        mainDict['gpt_application_search_answer'] = ''
        ...
        mainDict['inputOpenAIAPIKey'] = 'HIDDEN'
